...
namespace W
{
	...
	void ValleyScene::Initialize()
	{
		...
		pInterUI->GetComponent<Transform>()->SetPosition(0.f, -3.21f, -0.2f);
...

		{
			...
			pCameraComp->TrunLayerMask(eLayerType::UI, false);
		...
		{
			GameObject* pCamera = new GameObject();
			pCamera->SetName(L"UICam");
			AddGameObject(eLayerType::Camera, pCamera);
			pCamera->GetComponent<Transform>()->SetPosition(Vector3(0.f, 0.f, -10.f));
			Camera* pCameraComp = pCamera->AddComponent<Camera>();
			pCameraComp->TrunLayerMask(eLayerType::Background, false);
			pCameraComp->TrunLayerMask(eLayerType::Ladder, false);
			pCameraComp->TrunLayerMask(eLayerType::Object, false);
			pCameraComp->TrunLayerMask(eLayerType::NPC, false);
			//pCamera->AddComponent<CameraScript>();
		}
	}
